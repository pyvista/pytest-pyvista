# -*- coding: utf-8 -*-
#
# pytest-pyvista documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-pyvista Documentation',
     [author], 1)
]
