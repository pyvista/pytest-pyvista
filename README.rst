...
at once with **Accept all new**. Approving is reversible until you click **Export
approvals**, which downloads an ``approvals.json`` manifest describing what was ticked.
Apply it with the ``pytest-pyvista-approve`` console script:
